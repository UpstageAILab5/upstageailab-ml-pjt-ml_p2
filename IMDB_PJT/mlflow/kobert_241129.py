...
mlflow.set_experiment('IMDB_Kobert_1128')
...
def train_eval_model(dataset_labeled):
    ...
    with mlflow.start_run():
        ...
        mlflow.pytorch.log_model(model,
                                 registered_model_name='kobert_imdb')
...
def slack_notification(evaluation_result, model_path, dataset_path):
    message = f"""
...
if __name__ == "__main__":
    ...
    dataset = data_load()
    dataset_labeled, label2id, dataset_path = data_preprocess(dataset)
    model, model_path, evaluation_result = train_eval_model(dataset_labeled)
